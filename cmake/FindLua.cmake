...
FIND_PROGRAM (LUA_BINARY NAMES ${LUA_BINARY_NAME} PATHS /usr/bin /usr/local/bin)

IF (LUA_INCLUDE_DIR AND LUA_LIBRARY AND LUA_BINARY)
    SET (Lua_FOUND TRUE)
ENDIF (LUA_INCLUDE_DIR AND LUA_LIBRARY AND LUA_BINARY)
...
FIND_PACKAGE_HANDLE_STANDARD_ARGS(Lua  DEFAULT_MSG LUA_LIBRARY LUA_INCLUDE_DIR LUA_BINARY)

MARK_AS_ADVANCED ( LUA_INCLUDE_DIR LUA_LIBRARY LUA_BINARY)
